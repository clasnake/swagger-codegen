...
public class AkkaHttpScalaServerCodegen extends DefaultCodegen implements CodegenConfig {
    protected String groupId = "io.swagger";
    protected String artifactId = "akka-http-scala-server";
    protected String artifactVersion = "1.0.0";
    protected String sourceFolder = "src/main/scala";
    protected String packageName = "io.swagger";

    public AkkaHttpScalaServerCodegen() {
        super();
        outputFolder = "generated-code/akka-http-scala-server";
        modelTemplateFiles.put("model.mustache", ".scala");
        apiTemplateFiles.put("api.mustache", ".scala");
        embeddedTemplateDir = templateDir = "akka-http-scala-server";
...
//        supportingFiles.add(new SupportingFile("errors.mustache", sourceFolder, "errors.scala"));
        ...
        cliOptions.clear();
        cliOptions.add(new CliOption(CodegenConstants.PACKAGE_NAME, "Akka-http-scala-server package name")
    ...
    public String getName() {
        return "akka-http-scala-server";
    }

    @Override
    public String getHelp() {
        return "Generates a Scala server application with akka-http.";
    }
